...
<tr>
  ...
  <td class="formlttd">
    <div style="border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;width:520px;background:#fff;">
      ...
      <div class="js-diplomas-class-counters" style="padding:8px 10px;border-bottom:1px solid #e5e7eb;background:#fff;color:#6b7280;font-size:12px;">
        <span style="color:#9ca3af;">Selecione a turma para ver os contadores.</span>
      </div>
      ...
      <div style="padding:10px;color:#6b7280;font-size:11px;line-height:1.35;">
        Apenas matrículas <strong>concluídas/aprovadas/finalizadas</strong> aparecem na lista (regras oficiais do documento).
