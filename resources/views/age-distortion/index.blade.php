        ...
        <div class="advanced-report-card" style="margin-top: 12px;">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                <a class="btn-green" target="_blank"
                   href="{{ route('advanced-reports.age-distortion.pdf', array_merge(request()->all(), ['with_charts' => request('with_charts') ? 1 : 0])) }}">
                    Emitir PDF
                </a>
                <a class="btn" target="_blank"
                   href="{{ route('advanced-reports.age-distortion.excel', request()->all()) }}">
                    Exportar Excel
                </a>
            </div>
        </div>
